...
var A11yCarousel = function A11yCarousel(selector, userSettings) {
  ...
  this.setSlider = debounce(function () {
    ...
    // restart autoplay
    if (_this4.getSettings().autoPlay && _this4._isPlaying) {
      clearInterval(autoPlayInterval);
      window.autoPlayInterval = setInterval(_this4.autoPlay, _this4.getSettings().autoplaySpeed);
    }
  ...
  if (this.getSettings().autoplay) {
    ...
    if (this.getSettings().autoplay) {
      ...
      window.autoPlayInterval = setInterval(this.autoPlay, this.getSettings().autoplaySpeed);
      playBtn.classList.add('playing');
  ...
  document.addEventListener('click', debounce(function (e) {
    ...
    if (e.target && e.target.id == _this4._playId) {
      ...
      _this4._isPlaying = !_this4._isPlaying;
    }
    // prev
